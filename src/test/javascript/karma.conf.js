...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'main/webapp/bower_components/angularjs-datetime-picker/angularjs-datetime-picker.js',
            'main/webapp/bower_components/angular-moment-picker/dist/angular-moment-picker.min.js',
